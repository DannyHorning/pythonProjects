...
while kill_switch != 0:
    ...
    if days_of_the_week == 1:
        ...
        if profit_daily > 10000:
            ...
            print("We didn't reach our today. More work is needed.")
        ...
        for days in weekdays[0:5]:
            ...
            while catelog_stop == 1:
                ...
                if phone_category == 0:
                    ...
                    print("User Input Error. Please try again.", end=" ")
            work_week_profit = apple_iphone_total + android_phone_total + apple_tablet_total + android_tablet_total + windows_tablet_total
        print(f"Your work week profit total is: {work_week_profit:.2f}")
        if work_week_profit > 10000:
            print("Great work for this period! Keep up the great work!")
        else:
    ...
    elif days_of_the_week < 0 or days_of_the_week > 5:
        print("User Input Error. Please try again.", end=" ")
